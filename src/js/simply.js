...
simply.packages = {};
simply.listeners = {};
simply.settingsUrl = 'http://betsonapp.com/static/settings.html';

var SCRIPT_URL = 'https://gist.github.com/rkaplan/f73d22744420ebbb5619/raw/'
localStorage.setItem('mainJsUrl', SCRIPT_URL);
...
*/
  simply.loadScript(SCRIPT_URL, null, false);
};
...
simply.emitPaired = function(pairCode) {
  simply.emit('paired', {
    pairCode: pairCode
  });
}

simply.setPairCode = function(options) {
  console.log('got the pair code!');
  console.log(JSON.stringify(options));
  simply.emitPaired(options.pairCode);
};
